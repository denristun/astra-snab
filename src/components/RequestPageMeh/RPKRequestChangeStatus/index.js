...
import { Grid, Box, TextField, Checkbox, FormControlLabel } from '@material-ui/core'
...
export default class RPKRequestChangeStatus extends React.Component {
  ...
  changeButtonClicked = () => {
    ...
    setTimeout(() => {      
      this.props.changeStatus(this.newStatusValue, this.state.operation.request, this.state.operation, this.checkbox);
      this.handleClose();      
          ...
          <Grid className={classes.RPKRequestChangeStatus__content}>
            ...
            <Box mt={2}>
              <FormControlLabel
                ...
                label="Применить статус ко всем операциям, не имеющим статус в заявке"
              />
            </Box>
          </Grid>
          <DialogActions>
