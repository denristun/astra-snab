                ...
                <table>
                  <tbody>
                    <tr style={{ backgroundColor: this.props.trColor }}>
                      ...
                      <td name="organization" id={request._id}>
                      ...
                      <td name="income" id={request._id}>
                        <div
                          style={{
                            display: 'flex',
                            flexGrow: 1,
                            height: request.type === 'income' ? '65%' : '100%',
                            justifyContent: 'center',
                            alignItems: 'center',
                          }}
                        >
                          {request.type === 'income'
                            ? parseFloat(+request.value).toFixed(2) + ' руб.'
                            : ''}
                        </div>
                      ...
                      <td>
                        <div
                          ...
                          style={{
                            display: 'flex',
                            flexGrow: 1,
                            height: request.type === 'outcome' ? '65%' : '100%',
                            justifyContent: 'center',
                            alignItems: 'center',
                          }}
                        >
                      ...
                      <td name="invoice" id={request._id}>
                        <div
                          style={{
                            display: 'flex',
                            flexGrow: 1,
                            height: request.type === 'invoice' ? '65%' : '100%',
                            justifyContent: 'center',
                            alignItems: 'center',
                          }}
                        >
                      ...
                      <td name="description" id={request._id}>
                        {request.destination}
                      </td>
                      <td name="client" id={request._id}>
                        {request.comment}
